...
WebUI.setEncryptedText(findTestObject('Page_Registration Form/input_Registration Form_passwo'), 'fN5fAgN7IY/NGp189acx5w==')

WebUI.click(findTestObject('Page_Registration Form/button_Register User'))

WebUI.verifyTextNotPresent('User has been registered successfully', false)
